...
public class GuiModifiersManager
{
    ...
    public void draw(int mouseX, int mouseY, float partialTicks)
    {
        ...
        mc.fontRenderer.drawStringWithShadow(this.stringTitle, this.area.x + 6, this.area.y + 7, 0xffffff);
        ...
        if (this.fixture == null)
        {
            ...
            this.editor.drawCenteredString(mc.fontRenderer, this.stringSelect, x, y, 0xcccccc);
        }
        else if (h > 0)
        {
