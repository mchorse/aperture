...
public class GuiNullFixturePanel extends GuiAbstractFixturePanel<NullFixture>
{
    ...
    public GuiNullFixturePanel(Minecraft mc, GuiCameraEditor editor)
    {
        ...
        this.keys().register(IKey.lang("aperture.gui.panels.keys.previous"), Keyboard.KEY_P, () -> this.previous.clickItself(GuiBase.getCurrent())).held(Keyboard.KEY_LCONTROL).active(editor.dashboard::isFlightDisabled).category(CATEGORY);
    }
