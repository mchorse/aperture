...
public abstract class GuiAbstractModifierPanel<T extends AbstractModifier> implements IGuiModule
{
    ...
    public void draw(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (mouseX >= this.area.x && mouseY >= this.area.y && mouseX <= this.area.x + this.area.w && mouseY <= this.area.y + h)
        {
            ...
            this.enable.drawButton(this.modifiers.editor.mc, mouseX, mouseY, partialTicks);
            this.moveUp.drawButton(this.modifiers.editor.mc, mouseX, mouseY, partialTicks);
            this.moveDown.drawButton(this.modifiers.editor.mc, mouseX, mouseY, partialTicks);
        }
    }
}