...
public class L10n
{
    ...
    {
        sendWithMarker(sender, "§4(§cX§4)§r ", "aperture.error." + key, objects);
    }
    ...
    {
        sendWithMarker(sender, "§2(§aV§2)§r ", "aperture.success." + key, objects);
    }
    ...
    {
        sendWithMarker(sender, "§9(§bi§9)§r ", "aperture.info." + key, objects);
    }
